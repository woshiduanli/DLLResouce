...
namespace SimpleSpritePacker
{
	public class SPInstance : ScriptableObject {
        ...
        [SerializeField] private Dictionary<string, Sprite> SpriteDic = new Dictionary<string, Sprite>();
        public Dictionary<string, Sprite> SpriteDic_
        {
            get
            {
                return SpriteDic;
        ...
        {
            if (SpriteDic.Count == 0 || SpriteDic.Count != m_Sprites.Count)
                InitDic();
